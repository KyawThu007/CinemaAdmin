...
public class SharedData {
    ...
    private String[] genreList= {"Action","Adventure","Comedy","Drama","Fantasy","Historical","Horror","Musical","Mystery","Romance","Sci-Fi","Thriller","Western","Documentary","Biography","Crime","Animation"};
