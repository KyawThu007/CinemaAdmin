...
public class DashboardPanel extends javax.swing.JPanel {
    ...
    public void setCount() {
        ...
        for (Cinema cinema : list) {
            emp_count += new EmployeeImp().getAllEmployee(cinema.getId()).size();
            room_count += new RoomImp().getAllRoom(cinema.getId()).size();
        }
    ...
    public void cinemaLineChart() {
        final DefaultCategoryDataset dataset = new AnalysisImp().getCinemaAnalysis(Integer.parseInt(yearBox1.getSelectedItem().toString()), monthList);
        ...
        chartPanel.addChartMouseListener(new ChartMouseListener() {
            ...
            public void chartMouseClicked(ChartMouseEvent e) {
                ...
                if (entity instanceof CategoryItemEntity) {
                    ...
                    String message = String.format("Branch: %s, Month: %s, Value: %s", seriesKey, categoryKey, value);
    ...
    public void monthlyCinemaBarChart() {
        ...
        final DefaultCategoryDataset dataset = new AnalysisImp().getOnlyCinemaAnalysis(cinema_id, genreList, Integer.parseInt(yearBox2.getSelectedItem().toString()), month);
    ...
    public void cinemaPiechart() {
        final DefaultPieDataset dataset = new AnalysisImp().getCinemaAnalysisPieChart(Integer.parseInt(yearBox1.getSelectedItem().toString()), monthList);
