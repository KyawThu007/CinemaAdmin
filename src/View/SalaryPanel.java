...
public class SalaryPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(962, 600));
    ...
    public void getAllSalaryAction() {
        ...
        for (Salary salary : new SalaryImp().getAllSalary(cinema_id)) {
            Employee employee = new EmployeeImp().getEmployee(salary.getEmployee_id());
    ...
    private void updateSalaryAction() {
        ...
        if (selectedRow != -1) {
            ...
            new SalaryImp().updateSalary(salary);
            getAllSalaryAction();
    ...
    private void deleteSalaryAction() {
        ...
        if (selectedRow != -1) {
            // Get data from the selected row
            new SalaryImp().deleteSalary((int) salaryTable.getValueAt(selectedRow, 0));
            getAllSalaryAction();
        } else {
            // No row selected
            logMessage("Selected!");
